    ...
    def forward(
        ...
        Args:
            ...
            mask: the mask for the src sequence (optional).
                If batch_first=False, the mask shape should be (S, S).
                If batch_first=True, the mask shape should be (L, L).
                L is the sequence length, and S is the source sequence length.
                This is a self-attention mask that prevents position i from attending to
                position j (j > i).
                mask[i, j] = True allows attention; mask[i, j] = False blocks attention.
